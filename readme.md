...
You can find and read the pdf of our writeup [here](report/report.pdf)
...
![Relationships between court locations, and their distributions for players on offense](report/player_dist_and_relationships.png "Relationships between court locations and their distributions, for players on offense")
...
![Cumulative explained variance, PCA, on offense data](report/cum_pca_offense.png )
...
![Plot of loadings for players on offense](report/first_4_loadings_players_off.png )
...
![Plot of loadings for players on defense](report/first_4_loadings_players_def.png )
...
![Plot of loadings for teams on defense](report/first_4_loadings_teams_def.png )
...
![Plot of first two discriminants for LDA on offense data](report/LDA_players_teams_offense.png)
...
![Plot of first two discriminants for LDA on defense data](report/LDA_players_teams_defense.png)
